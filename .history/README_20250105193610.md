...
From genre button admin navigates to authors page where there are list of authors with edit and delete button and in bottom there is button to add new author.
