...
From publisher button admin navigates to publishers page where there are list of publishers with address, edit and delete button and in bottom there is button to add new author.
