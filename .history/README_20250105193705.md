...
From book button admin navigates to booklist page where there are list of books with edit and delete button and in bottom there is button to add new author.
