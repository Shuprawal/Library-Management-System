...
When admin logins from login page then in navbar there is additional button of category which is visible to only admin. From that button admin can go to many pages like authors, publisher, users, borrow, genre 
