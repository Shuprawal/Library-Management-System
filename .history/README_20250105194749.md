...
From clicking in readmore option admin will be redirected to book page where admin can see the detais of the books with edit, delete and feature button. Below book details there is comments section where user
