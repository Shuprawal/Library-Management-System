...
Route::put('bookEdit/{id}',[BookController::class,'update'])->name('book_update');
 ...
 // Route::get('borrowRequest',[BorrowController::class,'requestAccepted'])->name('requestList');

  Route::get('borrowRequest',[BorrowController::class,'show'])->name('requestList');

  Route::post('borrowRequest/{id}',[BorrowController::class,'store'])->name('book_borrow');
...
Route::patch('borrow/deny/{borrow}', [BorrowController::class, 'denyRequest'])->name('deny_request');

Route::patch('borrow/return/{borrow}', [BorrowController::class, 'approveRequest'])->name('approve_request');
