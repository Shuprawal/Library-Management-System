...
//  Route::get('list', [BookController::class, 'home'])->name('list');
Route::resource('publishers', PublisherController::class);
Route::put('/publisherEdit/{id}', [PublisherController::class, 'update'])->name('Route::post('/publisherEdit/{id}', [PublisherController::class, 'edit'])->name('publisher_edit');');