...
Route::post('/authorEdit/{id}', [AuthorControllerrController::class, 'edit'])->name('publisher_edit');


Route::get('/authorEdit/{id}', [PublisherController::class, 'edit'])->name('publisher_edit');
Route::put('/authorEdit/{id}', [PublisherController::class, 'update'])->name('publisher_update');