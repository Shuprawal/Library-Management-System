...
Route::get('authors', [GenreController::class, 'index'])->name('author.index');


Route::get('addauthor', [GenreController::class, 'create'])->name('author.create');


Route::post('addauthor', [GenreController::class, 'store'])->name('author.store');