...
Route::get('authors', [AuthorController::class, 'index'])->name('book.index');


Route::get('addauthor', [AuthorController::class, 'create'])->name('book.create');


Route::post('addauthor', [AuthorController::class, 'store'])->name('book.store');