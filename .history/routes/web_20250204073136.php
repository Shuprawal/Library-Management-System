...
Route::get('/', [BookController::class, 'featureList'])->name('home');
...
Route::middleware(['admin'])->group(function () {
    ...
    Route::get('user_list',[ProfileController::class,'userList'])->name('userList');
    Route::delete('user_list/{id}',[ProfileController::class,'userDelete'])->name('delete_user');
    ...
    Route::get('genrelist', [GenreController::class, 'try'])->name('genrelist');
    Route::delete('genrelist/{id}', [GenreController::class, 'try'])->name('delete_genre');
...
Route::get('search',[BookController::class,'searchList'])->name('search');
