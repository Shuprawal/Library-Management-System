...
Route::get('/dashboard', [DashbHomeControlleroardController::class, 'index'])->name('dashboard');
...
Route::put('/index/{id}',[BookController::class,'removeFeature'])->name('remove_feature');

Route::get('/', [BookController::class, 'featureList']);
