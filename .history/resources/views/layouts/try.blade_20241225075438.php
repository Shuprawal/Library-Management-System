                ...
                <ul class="navbar-nav  my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{route('Route::get('authorlist', [AuthorController::class, 'index'])->name('everylist');
Route::delete('autorlist/{id}', [AuthorController::class, 'destroy'])->name('delete_author');')}}" >Authors</a></li>
                            <li><a class="dropdown-item" href="#">Publishers</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @foreach ($genres as $genre)
                                {{--<!-- <li><a class="dropdown-item" href="{{route('booklist')}}">{{$genre->name}}</a></li> -->--}}
