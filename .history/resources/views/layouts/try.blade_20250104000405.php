            ...
            <div class=" navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav  my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{route('requestList')}}">Borrow</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href={{route('book_list')}}>All Books</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            @foreach ($genres as $genre)
                                 <li><a class="dropdown-item" href="{{route('booklist',$genre)}}">{{$genre->name}}</a></li> 
                    ...
                    <form class="d-flex" role="search" method="GET" action="search">
                        <input class="form-control search_bar me-2" name="search" type="search" placeholder="Search"
                            aria-label="Search">
                ...
                <li class="nav-item dropdown dropstart profil" style="">
                    ...
                    <ul class="dropdown-menu user-drop-list">
                        ...
                        @endguest
                        @auth
                            <li><a class="dropdown-item" href={{route('showProfile')}}>Profile</a></li>
                            <li><a class="dropdown-item" href={{route('borrowHistory')}}>Browing History</a></li>
                            <li><a class="dropdown-item" href={{route('showWishlist')}}>My Wishlist</a></li>
