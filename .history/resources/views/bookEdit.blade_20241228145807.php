...
<div class="container">
    ...
    <form action="{{route('book_update', $book->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea name="description" id="bookdescription" value="{{ old('description',$book->description) }}"
        ...
        <div class="mb-3">
            ...
            <input type="number" name="available_copies" id="available_copies" value="{{ old('available_copies',$book->description)"
