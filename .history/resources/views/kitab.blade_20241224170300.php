...
<div class="container">
    ...
    <form  action="{{route('book.store')}}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="mb-3">
            ...
            <ul id="genreDropdown" name="genre" class="dropdown-menu" style="width: 89%; display: none;">
                @foreach ($genres as $genre)
                    <li><label><input type="checkbox" value="{{ $genre->id }}"> {{ $genre->name }}</label></li>
                @endforeach
            </ul>
        ...
        <div class="mb-3">
            ...
            <ul id="authorsDropdown" nam="author" class="dropdown-menu" style="width: 89%; display: none; margin-top: -1px;">
        ...
        <div class="mb-3">
        <label for="bookdescription" class="form-label">Description</label>
        <textarea name="description" id="bookdescription" value="{{ old('description') }}"  class="form-control @error('description') is-invalid @enderror " ></textarea>
        
    </div>

    <div class="mb-3">
        <label for="bookavailable_copies" class="form-label">available_copies</label>
        <input type="number" name="available_copies" id="available_copies" class="form-control  @error('description') is-invalid @enderror " ></>
