...
<div class="container">
    ...
    <form  action="{{route('book.store')}}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="mb-3">
            ...
            <ul id="genreDropdown"  class="dropdown-menu" style="width: 89%; display: none;">
                @foreach ($genres as $genre)
                    <li><label><input type="checkbox" name="genreID[]" value="{{ $genre->id }}"> {{ $genre->name }}</label></li>
                @endforeach
            </ul>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <select name="publisherID" id="publisherID" class="form-select  @error('publisherID') is-invalid @enderror" >
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" id="authorsInput" name="authorsInput" class="form-control " placeholder="Select authors" readonly>
                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
        ...
        <div class="mb-3">
        <label for="bookdescription" class="form-label">Description</label>
        <textarea name="description" id="bookdescription" value="{{ old('description') }}"  class="form-control  " ></textarea>
    ...
    <div class="mb-3">
            ...
            <input type="date" name="published_date"   value="{{ old('published_date') }}"  class="form-control @error('published_date') is-invalid @enderror"  id="published_date" >
        ...
        <div class="mb-3">
            ...
            <input type="number" name="total_pages"   value="{{ old('total_pages') }}"  class="form-control @error('total_pages') is-invalid @enderror"  id="total_pages" >
            @error('total_pages')
                <p class="invalid-feedback">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="language"   value="{{ old('language') }}"  class="form-control @error('language') is-invalid @enderror"  id="language" >
            @error('language')
                <p class="invalid-feedback">{{ $message }}</p>
            @enderror
        </div>
...
<!-- Add Author Modal -->
<div class="modal fade" id="addAuthorModal" tabindex="-1" aria-labelledby="addAuthorModalLabel" aria-hidden="false">
    <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name"  id="genreName" class="form-control @error('name') is-invalid @enderror" required>
