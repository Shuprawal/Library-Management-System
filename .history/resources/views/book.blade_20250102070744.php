...
<div class="single-book container py-5">
            ...
            <div class="col my-2">
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <div id="rating-{{ $book->id }}" class="rating-container" data-id="{{ $book->id }}"
                            data-type="book">
                        ...
                        <p class="mt-2 mb-0">Book Average Rating: {{ round($book->averageRating(), 1) }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rate d-flex gap-3 m-2">
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    @foreach ($book->authors as $author)
                        <div class="mb-3">
                            ...
                            <div id="author-rating-{{ $author->id }}" class="rating-container" data-id="{{ $author->id }}"
                                data-type="author">
                                <span class="star" data-value="1">★</span>
                                <span class="star" data-value="2">★</span>
                                <span class="star" data-value="3">★</span>
                            ...
                            <p class="mt-2 mb-0">Author Average Rating: {{ round($author->averageRating(), 1) }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    <h5 class="fw-bold mb-3">Publisher Rating</h5>
                    <p class="fw-semibold mb-2">{{$book->publisher->name}}</p>
                    <div id="publisher-rating-{{ $book->publisher->id }}" class="rating-container"
                        data-id="{{ $book->publisher->id }}" data-type="publisher">
                        <span class="star" data-value="1">★</span>
                        <span class="star" data-value="2">★</span>
                        <span class="star" data-value="3">★</span>
                        <span class="star" data-value="4">★</span>
                    ...
                    <p class="mt-2 mb-0">Publisher Average Rating: {{ round($book->publisher->averageRating(), 1) }}</p>
                </div>
            </div>
        </div>
    </div>
