                ...
                <div class="comment-form mb-4">
                    <form class="needs-validation" novalidate method="POST" action="{{route('addReview',$book->id)}}">
                        ...
                        <div class="input-group">
                            <input type="text" name="review" class="form-control" placeholder="Write a comment..." required>
                    ...
                    <div class="comment-list">
                        ...
                        <div class="comment-item mb-3 p-3 bg-light rounded">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <button type="submit" class="gap-6"> <i class="bi bi-pen"></i> edit</button>
                                <button type="submit"> <i class="bi bi-trash-fill"></i> delte</button>
                                @endif
                            </div>
