...
<div class="modal fade" id="addPublisherModal" tabindex="-1" aria-labelledby="addPublisherModalLabel"
    ...
    <div class="modal-dialog">
        <form id="addPublisherForm" action="{{ route('publisher.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            class="form-control @error('name') is-invalid @enderror" id="validationDefaultUsername"
                            required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="address" value="{{ old('address') }}"
                            class="form-control @error('address') is-invalid @enderror" id="validationDefault01"
                            required>
