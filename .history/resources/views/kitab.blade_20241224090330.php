...
<div class="container">
    <h2>Add New Book</h2>
    <form  action="{{route('book.stre')}}" method="POST" enctype="multipart/form-data" >
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <input type="file" name="image"  class="form-in"  />
        ...
        <div class="mb-3">
        <label for="bookdescription" class="form-label">Description</label>
        <textarea name="description" id="bookdescription" class="form-control" ></textarea>
        
    </div>

    <div class="mb-3">
        <label for="bookdescription" class="form-label">available_copies</label>
        <input type="number" name="available_copies" id="bookdescription" class="form-control " ></>
