...
<h3 class="fw-bold text-primary" >Create Profile</h3>
  ...
  <div class="mb-3">
    ...
    <input type="text" name="contact_number" class="form-control @error('address') is-invalid @enderror" id="exampleInputContact1">
  </div>
 
  <div class="mb-3">
    <label for="exampleInputDOB" class="form-label">Date Of Birth</label>
    <input type="date" name="date_of_birth" class="form-control @error('address') is-invalid @enderror" id="exampleInputDOB">
</div>
