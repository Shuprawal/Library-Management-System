    ...
    <div class="row g-4">
        ...
        <div class="col-md-7 col-lg-8">
            <div class="book-details bg-white p-4 rounded shadow-sm">
                ...
                <!-- Genre Tags -->
                <div class="genre-tags mb-2 d-flex gap-1">
                    <h6 class="fw-bold text-primary mb-1">Genre:</h6>
                ...
                <div class="genre-tags mb-2 d-flex gap-1">
                    <h6 class="fw-bold text-primary mb-1">Language:</h6>
                    <div class="d-flex gap-2 flex-wrap">
                ...
                <div class="genre-tags mb-2 d-flex gap-1">
                    <h6 class="fw-bold text-primary mb-1">ISBN:</h6>
                    <div class="d-flex gap-2 flex-wrap">
                ...
                <div class="action-buttons">
                    ...
                    @else
                        ...
                        <form  style="display:inline-block;" disabled>
                            @csrf
                            <button type="submit" class="btn btn-danger me-2">
                            <i class="bi bi-check-circle"> </i>Not available
                            </button>
