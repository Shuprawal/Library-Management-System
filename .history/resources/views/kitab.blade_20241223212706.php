...
<div class="container">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="isbn" value="{{ old('isbn') }}"  class="form-control @error('name') is-invalid @enderror  " id="isbn" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <input type="file" value="{{ old('name') }}"  class="form-control @error('name') is-invalid @enderror  " id="inputGroupFile01" accept="image/*">
            </div>
        </div>
