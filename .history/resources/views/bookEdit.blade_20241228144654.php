...
<div class="container">
    ...
    @csrf
        <div class="mb-3">
            ...
            <input type="text" name="name" value="{{ old('name',$book->name) }}"  class="form-control @error('name') is-invalid @enderror" id="name" >
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="isbn"   value="{{ old('isbn',$book->isbn) }}"  class="form-control @error('isbn') is-invalid @enderror"  id="isbn" >
            @error('isbn')
                <p class="invalid-feedback">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" id="genreInput" value="{{old('genre',$book->genre->name)}}" class="form-control " placeholder="Select genres" readonly>
            ...
            <ul id="genreDropdown"  class="dropdown-menu" style="width: 89%; display: none;">
                @foreach ($genres as $genre)
                    <li><label><input type="checkbox" name="genreID[]" value="{{ $genre->id }}"
                    {{ in_array($genre->id, $book->genres->pluck('id')->toArray()) ? 'checked' : '' }}> {{ $genre->name }}</label></li>
                @endforeach
            </ul>
        </div>
