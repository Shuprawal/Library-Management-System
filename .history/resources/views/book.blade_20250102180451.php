            ...
            <div class="book-details bg-white p-4 rounded shadow-sm">
                ...
                <div class="action-buttons">
                    ...
                    @if (Auth::check() && Auth::user()->isAdmin())
                        ...
                        <form action="{{route('book_feature', $book->id)}}" method="POST" style="display:inline-block;">
                            @csrf
            ...
            <div class="col">
                <div class="card h-100 shadow-sm hover-shadow">
                    ...
                    <div class="card-footer bg-transparent">
                        <a type="submit" class="btn btn-primary" href="{{route('book', $morebook->id)}}">Read more</a>
