                ...
                <div class="card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <div  class="rating-container">
                            <form action="{{route('rate',['type' => 'book', 'id' => $book->id])}}" class="star" value="1" method="POST" style="display:inline-block;">
                                @csrf
                                <button type="submit"></button>★
                            </form>
                            <form action="" class="star" value="2" method="POST" style="display:inline-block;">
                                @csrf
                                ★
                            </form>
                            <form action="" class="star" value="3" method="POST" style="display:inline-block;">
                                @csrf
                                ★
                            </form>
                            <form action="" class="star" value="4" method="POST" style="display:inline-block;">
                                @csrf
                                ★
                            </form>
                            <form action="" class="star" value="5" method="POST" style="display:inline-block;">
                                @csrf
                                ★
                            </form>
