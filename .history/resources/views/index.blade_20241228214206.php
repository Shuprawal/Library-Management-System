                    ...
                    <div class="row g-5 align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="pe-lg-5">
                                ...
                                <h2 class="display-5 fw-bold mb-3">Book one The book called xyz abc</h2>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="pe-lg-5">
                                <h6 class="text-primary text-uppercase mb-3">Featured Book</h6>
                                <h2 class="display-5 fw-bold mb-3">Book Two The book called abc xyz</h2>
                                
                                <div class="d-flex align-items-center mb-4">
                                    <img src="{{ asset('/img/avatar-placeholder.jpg') }}" 
                                ...
                                <p class="lead mb-4">This is the description for the second slide. You can add more details here as needed. 
                                   This is the description for the second slide. You can add more details here as needed. 
                                   This is the description for the second slide.</p>
