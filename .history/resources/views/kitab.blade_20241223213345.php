...
<div class="container">
    ...
    <form method="POST" action="{{rou}}">
        ...
        <div class="mb-3">
            ...
            <input type="number" value="{{ old('available_copy') }}"  class="form-control @error('available_copy') is-invalid @enderror  " name="available_copy" id="availability">
