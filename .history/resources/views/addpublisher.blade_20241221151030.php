  ...
  <form class="row g-3 addform p-2 m-2" action="{{route('publisher.store')}}" method="POST">
    ...
    <div class="col-md-4">
      ...
      <div class="input-group">
        <input type="text" name="name"class="form-control @error('address') is-invalid @enderror" id="validationDefaultUsername"
    ...
    <div class="col-md-4">
      ...
      <input type="text" name="address" class="@error('address') is-invalid @enderror form-control" id="validationDefault01" >
      @error('name')
        <p class="invalid-feedback">{{$message}} </p>
      @enderror
    </div>
