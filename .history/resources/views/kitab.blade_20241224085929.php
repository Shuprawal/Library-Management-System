...
<div class="container">
    ...
    <form  action="{{route('book.store')}}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="mb-3">
        <label for="bookdescription" class="form-label">Description</label>
        <textarea name="description" id="bookdescription" class="form-control r" ></textarea>
        
    </div>

    <div class="mb-3">
        <label for="bookdescription" class="form-label">available_copies</label>
        <input type="number" name="available_copies" id="bookdescription" class="form-control @error('available_copies') is-invalid @enderror" ></>
