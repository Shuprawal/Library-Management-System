...
@csrf
    <div class="col-md-4">
        ...
        <div class="input-group">
            <input type="text" name ="name" value="{{old('name'),$author-}}" class="form-control  @error('name') is-invalid @enderror " id="validationDefaultUsername" aria-describedby="inputGroupPrepend2" required>
            @error('name')
