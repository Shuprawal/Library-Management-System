...
<div class="single-book container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-7 col-lg-8">
            <div class="book-details bg-black p-4 rounded shadow-sm">
                <!-- Book Metadata Grid -->
                ...
                <div class="book-description mb-4">
                    ...
                    <p class="text-muted">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique nesciunt debitis deserunt tempora amet quia natus at obcaecati voluptas, mollitia fuga numquam esse optio provident praesentium facilis possimus velit libero.</p>
                    <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero cum fugiat consectetur id mollitia necessitatibus laudantium in esse doloribus voluptatibus distinctio.</p>
                </div>
