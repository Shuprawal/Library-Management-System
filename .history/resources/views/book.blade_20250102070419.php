                ...
                <div class="card-body text-center">
                    ...
                    @foreach ($book->authors as $author)
                        <div class="mb-3">
                            ...
                            <div id="author-rating-{{ $author->id }}" class="rating-container" data-id="{{ $author->id }}" data-type="author">
                                <span class="star" data-value="1">★</span>
                                <span class="star" data-value="2">★</span>
                                <span class="star" data-value="3">★</span>
                                <span class="star" data-value="4">★</span>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    <div id="publisher-rating-{{ $book->publisher->id }}" class="rating-container" data-id="{{ $book->publisher->id }}" data-type="publisher">
                        <span class="star" data-value="1">★</span>
                        <span class="star" data-value="2">★</span>
                        <span class="star" data-value="3">★</span>
                        <span class="star" data-value="4">★</span>
