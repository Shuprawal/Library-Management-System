...
<div class="container">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" value="{{ old('name') }}"  class="form-control @error('name') is-invalid @enderror  " id="title" required>
        </div>

        <div class="mb-3">
            <label for="isbn" class="form-label">ISBN</label>
            <input type="text" name="isbn" value="{{ old('isbn') }}"  class="form-control @error('isbn') is-invalid @enderror  " id="isbn" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <input type="file" value="{{ old('image') }}"  class="form-control @error('image') is-invalid @enderror  " id="inputGroupFile01" accept="image/*">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" id="genreInput" value="{{ old('name') }}"  class="form-control @error('name') is-invalid @enderror  " placeholder="Select genres" readonly>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" id="authorsInput" value="{{ old('name') }}"  class="form-control @error('name') is-invalid @enderror  " placeholder="Select authors" readonly>
                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
        ...
        <div class="mb-3">
            ...
            <textarea value="{{ old('name') }}"  class="form-control @error('name') is-invalid @enderror  " aria-label="With textarea"></textarea>
        </div>

        <div class="mb-3">
            <label for="availability" class="form-label">Avilable Copies</label>
            <input type="number" value="{{ old('name') }}"  class="form-control @error('name') is-invalid @enderror  " name="available_copy" id="availability">
        </div>
