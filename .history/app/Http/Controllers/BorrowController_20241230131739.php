    ...
    public function show()
{
    ...
    $returned = Borrow::where('request', 'approved')->where( 'status','borrowed')->get(); 
    return view('borrowRequest', compact('pendingRequests','acceptedRequests'));
}
...
public function showHistory()
{
    ...
    return view('borrowHistory', compact('pendingRequests','acceptedRequests'));
}
