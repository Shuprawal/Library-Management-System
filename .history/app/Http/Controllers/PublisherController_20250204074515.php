...
class PublisherController extends Controller
{
    ...
    {
        $publishers = Publisher::orderBy('created_at',"desc")->paginate();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $rules = [
            'name' => [
                'required',
                'regex:/^[a-zA-Z\s]+$/',
                Rule::unique('publishers', 'name')->ignore($publisher->id), // Ignore current publisher
            ],
            'address' => 'required',
        ];
        ...
        return redirect()->route('publisher.index')->with('sucess','New publisher updated sucesfully');   
    }
