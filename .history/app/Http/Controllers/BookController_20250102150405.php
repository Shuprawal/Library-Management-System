    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $book = Book::create([
                ...
                'image' => $pathOfPhoto,
                'published_date'=>$request->input('language'),
                'total_pages'=>$request->input('language'),
            ...
            return redirect()->route('books.index')->withInput()->with('error', 'An unexpected error occurred while saving the book.');
        }
    }
    ...
    public function sortList(Request $request)
{
    ...
    return view('list', ['books' => $books->get()]);
}
