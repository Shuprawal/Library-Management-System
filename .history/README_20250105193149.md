...
Admin Interface
After loging in admin home page is displayed where in navigation there are buttons for Home, Category, Genre, Contact us, Search bar and Profile button. From category option admin can navigate to other pages like auth
