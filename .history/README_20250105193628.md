...
From genre button admin navigates to genre page where there are list of genre with edit and delete button and in bottom there is button to add new author.
