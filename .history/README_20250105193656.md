...
From book button admin navigates to book page where there are list of authors with edit and delete button and in bottom there is button to add new author.
